...
# Метод должен искать контакт по уникальному id в списке contacts и возвращать словарь 
# из него с указанным ключом id . Если словаря с указанным id в списке contacts не найдено, 
