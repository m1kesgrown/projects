...
# filename — имя файла для упаковки объекта класса Contacts, contacts — список контактов, 
...
# Разработайте два метода для сериализации и десериализации экземпляра класса Contacts с помощью 
# пакета pickle и хранения полученных данных в бинарном файле.
# Первый метод save_to_file сохраняет экземпляр класса Contacts в файл, используя метод dump 
# пакета pickle. Имя файла хранится в атрибуте filename.
